...
# yaha only BicepsCurlDetector k liye logic denge
# same hi logic squat wala yaha bhi rahta hai 
class BicepsCurlDetector(BaseExercise):
    ...
    def __init__(self):
        super().__init__()
        self._shoulder_x_baseline = None #ye extra variable de rahe hai 
...
# ye do parameter hm le rahe hai
...
# atan2 yaha hm arc tangent used kr rahe hai angle k liye pahle hm arc cos find krte the
# because yaha do parameter le rahe hai (dx,dy)
    def _safe_angle(self, dx, dy):
        # yaha agar dy 0 nii hai ya to 0 hoga
