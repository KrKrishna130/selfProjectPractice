# yaha workout me options k liye kya kya honge ye yaha dete hai
# yaha se ab hm sidha import kr lenge har jagah likhne ki jarurat nii
# ye sare drop down me aayenge -workout k
EXERCISE_OPTIONS=[
    "Squats",
    "Push-ups",
...
# yaha hmne tuples generate kiya hai(starting index,last index) ye vale hai
# isko bad me used hoga
POSE_CONNECTIONS = [
